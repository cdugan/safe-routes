...
if __name__ == '__main__':
    # Example: Route using addresses
    # You can use either addresses (strings) or coordinates (tuples of (lat, lon))
    # Down Main STreet
    # START_ADDRESS = "1972 Haywood Rd, Hendersonville, NC 28791"
    # END_ADDRESS = "101B 1st Ave W, Hendersonville, NC 28792"
    

    START_ADDRESS = "5411 Hendersonville Rd, Fletcher, NC 28732"
    # END_ADDRESS = "59 Shaws Creek Farm Rd, Hendersonville, NC 28793"
    # Alternative: use coordinates directly (uncomment to use instead of addresses)
    # START_ADDRESS = (35.363019, -82.530796)  # Rugby and Arbor Ln
    END_ADDRESS = (35.320609, -82.494951)    # home
    
    print("=" * 60)
    print("Route Visualizer: Fastest vs Safest Routes")
    print("=" * 60)
    
    results = compare_routes(BBOX, START_ADDRESS, END_ADDRESS)
    
    print("\n" + "=" * 60)
    print("Summary:")
    if results['fastest']['route']:
        print(f"Fastest route: {results['fastest']['time']:.1f} seconds")
    if results['safest']['route']:
        print(f"Safest route:  {results['safest']['time']:.1f} seconds")
    print("=" * 60)
